.data
    colonseparator:        .asciiz ": "            # a colon string with $space.
    input_msg:             .asciiz "Input value: "
    newline:               .asciiz "\n"         # a newline string.
    receive_values_msg:    .asciiz "Input value#"
    sorted_array_msg:      .asciiz "Sorted:"
...
main:
    params_info:
        ...
        la    $a0, question_msg         # load pa$rams_info_string to argument register $$a0.
...
quick_sort:
    ...
    jal partition               # v0 = partition(arr, l, r)
