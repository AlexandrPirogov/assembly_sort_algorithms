.data
    ...
    input_msg:           .asciiz "Input value for each iteration: \n"
    input_values:       .asciiz "Your Input value # "
    newline:            .asciiz "\n"        # a newline string.
    params_info_str:    .asciiz "Input number of values to be sorted (0 < N < 1000): "
    sorted_array:                .asciiz "Sorted:\n"
    delim:              .asciiz " "         # a delim string.
...
main:
    ...
    receive_values_loop_info:
        li  $v0, 4               # 4 = print_string syscall.
        la  $a0, input_msg       # load input_msgion to argument register $a0.
        syscall                  # issue a system call.
    ...
    input_values_end:
        ...
        li  $v0, 4              # 4 = print_string syscall.
        la  $a0, sorted_array    # load sorted_array to argument register $a0.
        syscall             
        li  $v0, 4          
